...
# 内核替换 kernel xxx
sed -i 's/LINUX_KERNEL_HASH-6.12.54 = 1b0dcd3390efeec44e528748609bafcf36eae895bb68c8f62ac5e5940943de62/LINUX_KERNEL_HASH-6.12.55 = 328f8f4608a653063a5fd82d29b17163faab2825fa419fa85b961740a342fb9f/g' ./target/linux/generic/kernel-6.12
sed -i 's/LINUX_VERSION-6.12 = .54/LINUX_VERSION-6.12 = .55/g' ./target/linux/generic/kernel-6.12
