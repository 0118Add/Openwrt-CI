...
# 修改系统文件
curl -fsSL https://raw.githubusercontent.com/0118Add/Openwrt-CI/main/x86/diy/x86_lede/index_x86.htm.lean > ./package/lean/autocore/files/x86/index.htm
...
# 添加额外软件包
#git clone https://github.com/0118Add/Cloudbuild package/myautocore
