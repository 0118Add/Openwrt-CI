...
curl -fsSL https://raw.githubusercontent.com/0118Add/Openwrt-CI/main/patch/25.12/os-release > package/base-files/files/etc/os-release
...
### Fullcone-NAT 部分 ###
# bcmfullcone
curl -s PATCH/kernel/bcmfullcone/* ./target/linux/generic/hack-${KERNEL_VERSION}/
...
curl -s PATCH/pkgs/firewall/libnftnl/*.patch ./package/libs/libnftnl/patches/
...
### NAT6 部分 ###
# custom nft command
patch -p1 < Openwrt-CI/PATCH/pkgs/firewall/100-openwrt-firewall4-add-custom-nft-command-support.patch
