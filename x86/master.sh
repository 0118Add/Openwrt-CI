...
git clone https://$github/sbwml/package_libs_nghttp3 feeds/packages/libs/nghttp3

# ngtcp2
rm -rf feeds/packages/libs/ngtcp2
git clone https://$github/sbwml/package_libs_ngtcp2 feeds/packages/libs/ngtcp2
...
sed -i 's/PKG_RELEASE:=1/PKG_RELEASE:=3/g' feeds/packages/net/miniupnpd/Makefile
...
# Luci diagnostics.js
sed -i "s/immortalwrt.org/www.baidu.com/g" feeds/luci/modules/luci-mod-network/htdocs/luci-static/resources/view/network/diagnostics.js
...
patch -p1 -d feeds/luci < ../data/luci/0001-luci-app-package-manager-support-installing-uploaded.patch
