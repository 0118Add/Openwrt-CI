...
sed -i 's/LINUX_KERNEL_HASH-4.19.246 = 00ad2f5a36c91221a2ade0078b93bf84b60d494bd1ef51eaccb5bdb6277dba3a/LINUX_KERNEL_HASH-4.19.274 = 64a265a193c9e3e14d1397278e2348386ef6d6043af76d693c0fbbafed345ca8/g' ./include/kernel-version.mk
sed -i 's/LINUX_VERSION-4.19 = .246/LINUX_VERSION-4.19 = .274/g' ./include/kernel-version.mk
