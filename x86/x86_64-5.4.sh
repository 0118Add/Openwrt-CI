...
sed -i 's/LINUX_KERNEL_HASH-5.4.230 = a74fd32ccc1025b72f3ba7183208761f7c6190fb96e8f484f6d543a5a183e62f/LINUX_KERNEL_HASH-5.4.231 = 8dd0ea7f1db4c1e89d485255798e3c3dfb9be63c0f2af369912a1a37b75f36a8/g' ./include/kernel-5.4
sed -i 's/LINUX_VERSION-5.4 = .230/LINUX_VERSION-5.4 = .231/g' ./include/kernel-5.4
